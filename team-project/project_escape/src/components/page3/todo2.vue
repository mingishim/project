                ...
                <br>
                    <br>
                        ...
                        <img src="../page3/백경이홧팅.png" id="fighting1">
                            <img src="../page3/백경이홧팅.png" id="fighting2"></section>

                            <form id="new-todo-form" @submit.prevent="addTodo">
                                <h4 id="title-two">
                                    <center>오늘 랩실에서 할 일을 입력해 주세요!</center>
                                </h4>
                                <center>
                                    <br>
                                        <input
                                ...
                                <div
                                    ...
                                    v-bind:key="`todo-item ${todo.done && 'done'}`">
                                    <label>
                            ...
                            <div>
                                <img id="teacher-whale" src="../page3/백경쌤.png"></div>
